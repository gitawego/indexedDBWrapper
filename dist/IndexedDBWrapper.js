...
var IndexedDBWrapper = (function (BaseEvented) {
  ...
  IndexedDBWrapper.prototype.bulk = function (items, storeName) {
    var _this2 = this;
    return new Promise(function (resolve, reject) {
      var i = 0, parsedItems = [], itemStore = _this2.getStore(storeName, "readwrite", {
        onerror: reject
      }), res = [];
...
var helper = {
 ...
 if (typeof define==='function' && define['amd']){define(function(){return IndexedDBWrapper;});}else if (typeof module !=='undefined' && module['exports']){module['exports']=IndexedDBWrapper;}else if (typeof this !=='undefined'){this['IndexedDBWrapper']=IndexedDBWrapper;}  }).bind(window)();
